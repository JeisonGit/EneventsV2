<?php
    ...
    // Recupera la informacion del resultado
    $fila = InformacionResultadoModificar($cod);

    // Modifica los datos del resultado
    if(isset($_POST['Actualizar'])){
        ModificarResultado($cod);
    }
...
<?php include('includes/headerAdmin.php') ?>
        ...
        <div class="container d-flex justify-content-center">
            <div class="col-lg-8 my-3">
                ...
                <div class="card rounded-2 border">
                    ...
                    <!-- FORMULARIO DEL RESULTADO A MODIFICAR -->
                    <div class="card-body">
                        <form action="" method="post" class="carta-formulario">

                            <!-- VALOR DE ENTRADA Y ASISTENCIA -->
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <input type="number" name="asistencia" id="asistencia" class="form-control mb-3" value="<?php print $fila['Asistencia'] ?>" placeholder="Cantidad de personas que asistieron" min="0" max="999999" required>
                                </div> 
                            </div>
                            ...
                            <div class="row">    
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <input type="number" name="ingresosadicionales" id="ingresosadicionales" class="form-control mb-3" value="<?php print $fila['IngresosAdicionales'] ?>" placeholder="Ganancia obtenida mediante servicios 'secundarios'" min="0" max="999999999" required>
                                </div>
                            </div>
    ...
    <!-- ACTIVAR EL CKEDITOR EN EL TEXTAREA DLE FORMULARIO -->
    <script>
