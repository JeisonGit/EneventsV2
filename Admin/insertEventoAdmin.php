...
<!-- INVOCO HEADER DEL ADMIN -->
<?php include('includes/headerAdmin.php') ?>

    <!-- SECCION QUE CONTIENE EL FORMULARIO DEL EVENTO A REGISTRAR -->
            ...
            <div class="col-lg-10 my-3">
                ...
                <div class="card rounded-2 border">
                    ...
                    <div class="card-header container-info">
                        <h6 class="font-weight-bold mb-0">Ingresa la Información del Evento Administrativo</h6>
                    </div>
                    ...
                    <!-- FORMULARIO -->
                        <form action="" method="post" enctype="multipart/form-data" class="carta-formulario" >
                            ...
                            <!-- LUGAR Y COSTO DE INGRESO AL EVENTO -->
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
