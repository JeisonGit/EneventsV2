<?php
    ...
    $eventosActivos = BuscarEventosActivosCategoria();
    $eventosInactivos = BuscarEventosInactivosCategoria();

    // Cuento la cantidad de registros de las consultas
    ...
    <div class="container bg-white div-buscarEventos">
        ...
        <section class="pb-4">
            <div class="container" data-aos="fade-up">
                ...
                <p class="lead pt-3">Filtrar Eventos por la Categoría: <b class="font-weight-bold"><?php print $categoria ?></b></p>
