<?php
    ...
    // Recupero las fechas ingresadas mediante el modal
    $fechaAntigua = $_POST['fechaAntigua'];
    $fechaReciente = $_POST['fechaReciente'];

    $eventosActivos = BuscarEventosActivosFechas();
    $eventosInactivos = BuscarEventosInactivosFechas();

    // Cuento la cantidad de registros traidos mediante las consultas
    $countResultadoActivos = mysqli_num_rows($eventosActivos);
    $countResultadoInactivos = mysqli_num_rows($eventosInactivos);

    // Asigno formato de fechas
    $fechaAntigua = date_create($fechaAntigua);
    $fechaAntigua = date_format($fechaAntigua, "d-m-Y");
    
    $fechaReciente = date_create($fechaReciente);
    $fechaReciente = date_format($fechaReciente, "d-m-Y");
    ...
    <div class="container bg-white div-buscarEventos">
        ...
        <section class="pb-4">
            <div class="container" data-aos="fade-up">
                ...
                <p class="lead pt-3">Filtrar: Eventos que se realizarán / realizarón entre el <b class="font-weight-bold"><?php print $fechaAntigua ?></b> y el <b class="font-weight-bold"><?php print $fechaReciente ?></b> </p>
