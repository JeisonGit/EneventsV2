<?php
    ...
    $fila = InformacionResultadoSeleccionUsuario($codigo);
...
<?php include('includes/headerUsuario.php') ?>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row my-4 mx-2">
                                        <div class="col-lg-12">
                                            ...
                                            <a href="updateResultado.php?cod=<?php print $fila['Codigo']; ?>" class="btn btn-info mb-3 font-weight-bold">Modificar Resultado</a>
    ...
    <!-- FIN SECCION INFORMACIÓN EVENTO Y RESULTADO -->
