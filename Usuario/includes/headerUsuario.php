                    ...
                    <li>
                        ...
                        <li>
                            ...
                            <ul class="collapse lisst-unstyled lista-menu" id="submenueventos">
                                <li>
                                    <a href="insertEvento.php" class="d-block text-light p-2"><i class="far fa-calendar-plus mr-2 lead"></i>Agregar Evento </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="selectEventos.php?Estado=Espera" class="d-block text-light p-2"><i class="far fa-calendar-minus mr-2 lead"></i>Eventos en Revisión</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="reportes.php" class="d-block text-light p-3"><i class="far fa-clipboard mr-2 lead"></i> Reportes</a>
                        </li>
                        <li>
                            <a href="configUsuario.php" class="d-block text-light p-3"><i class="far fa-cogs mr-2 lead"></i> Configuración</a>
                        </li>
                        <li>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon ion-md-person mr-2 text-white lead"></i>Usuario</a>
